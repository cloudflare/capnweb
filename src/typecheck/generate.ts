...
import type { ClassRegistration, ExtractedClassSpec, GenOptions, GenResult, TypeSpec } from "./types.js";
...
function emitSpecsModule(classes: ExtractedClassSpec[]): string {
