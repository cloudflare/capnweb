...
// "capnweb-validate/internal" automatically and user source never references
...
function fail(path: PropertyPath, expected: string, value: unknown): never {
  ...
  throw new RpcValidationError(
    `capnweb-validate: at ${formatPath(path)}: expected ${expected}, got ${actual}`,
...
// into
//   __rt.__newRpcSessionwithValidation(transport, __validator)
...
export function __newRpcSessionwithValidation<T extends capnweb.RpcCompatible<T>>(
