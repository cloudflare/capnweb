...
env NODE_OPTIONS= node \
  "$REPO_ROOT/packages/capnweb-validate/dist/cli.cjs" build \
  --cwd "$SCRIPT_DIR" \
  --out "$OUT_DIR"
...
"capnweb-validate" = "$REPO_ROOT/packages/capnweb-validate/dist/index.mjs"
"capnweb-validate/internal" = "$REPO_ROOT/packages/capnweb-validate/dist/internal/runtime.mjs"
...
cat > "$OUT_PATH/tsconfig.json" <<EOF2
{
  "compilerOptions": {
    ...
    "paths": {
      ...
      "capnweb-validate": ["$REPO_ROOT/packages/capnweb-validate/dist/index.d.mts"],
      "capnweb-validate/internal": ["$REPO_ROOT/packages/capnweb-validate/dist/internal/runtime.d.mts"]
    }
  },
  "include": ["src/**/*"]
}
