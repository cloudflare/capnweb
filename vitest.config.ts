    ...
    projects: [
      // Node.js
      {
        test: {
          ...
          include: ['__tests__/index.test.ts', '__tests__/flow-control.test.ts', '__tests__/typecheck.test.ts', '__tests__/typecheck-package.test.ts', '__tests__/vite-plugin.test.ts'],
          environment: 'node',
        },
      },
